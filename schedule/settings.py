...
# En producción, asegúrate de tener DEBUG=False en tu .env
DEBUG = env_bool("DJANGO_DEBUG", default=False)  # Por defecto False para seguridad
...
# Estas settings se activarán cuando DEBUG=False
if not DEBUG:
    SECURE_SSL_REDIRECT = env_bool("SECURE_SSL_REDIRECT", False)  # Activar si usas HTTPS
